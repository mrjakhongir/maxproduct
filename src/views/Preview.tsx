	...
	return (
		<div className='p-5 flex flex-col'>
			...
			<div className='flex flex-col gap-5'>
				<div
					className='w-[794px] h-[1123px] mx-auto shadow-2xl border border-slate-400 bg-[url("/1.png")] bg-contain bg-center bg-no-repeat'
					ref={pageOneRef}></div>
				<div
				...
				<div
					className='w-[794px] h-[1123px] mx-auto shadow-2xl border border-slate-400 bg-[url("/3.png")] bg-contain bg-center bg-no-repeat'
					ref={pageThreeRef}></div>
				<div
					className='w-[794px] h-[1123px] mx-auto shadow-2xl border border-slate-400 bg-[url("/2.png")] bg-contain bg-center bg-no-repeat'
					ref={pageFourRef}></div>
			</div>
		</div>
	);
